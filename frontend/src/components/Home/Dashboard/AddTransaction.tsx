    ...
    <div className='fixed inset-0 bg-black/40 bg-opacity-50 flex items-center justify-center z-50'>
      <div className='bg-white rounded-xl p-6 w-[525px] max-h-[90vh] overflow-y-auto'>
            ...
            <>
              <div className='flex flex-col gap-1'>
                <div className='flex flex-row items-center gap-2'>
                  ...
                  <label htmlFor='incomeSource' className='font-semibold text-lg'>Income Source *</label>
                </div>
                <input
                  type="text"
                  id="incomeSource"
                  name="incomeSource"
                  value={transaction.incomeSource}
                  onChange={handleTransactionChange}
        ...
        <div className='flex flex-row w-full justify-end gap-4 mt-6'>
          ...
          <button 
            type="button"
            className={`flex flex-row items-center px-4 py-2 rounded-lg gap-2 cursor-pointer transition-colors ${
              transactionType === 'income'
